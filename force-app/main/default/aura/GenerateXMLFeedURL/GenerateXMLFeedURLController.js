    ...
    copyInputFieldValue : function(component, event, helper) {
        ...
        if(buttonAuraId == 'btn1'){
            ...
            if (outputElements.length > 0) {
                ...
                outputValue = 'https://houzonrealestatellc.my.salesforce-sites.com/XMLFeedForPF?Id='+component.get("v.selectionCategory.Id");
            ...
            if (outputElements.length > 0) {
                ...
                outputValue = 'https://houzonrealestatellc.my.salesforce-sites.com/XMLFeed?Id='+component.get("v.selectionCategory.Id");
                console.error('In else-->',outputValue);
            }
            helper.copyTextHelper(component,event,outputValue);
        }    
